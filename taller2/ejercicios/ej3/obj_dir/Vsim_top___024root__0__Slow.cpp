            ...
            if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
                {
                    ...
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__rst 
                        = ((IData)(vlSelfRef.sim_top__DOT__rst) 
                           | (IData)(vlSelfRef.sim_top__DOT__tb__DOT__rst_extra));
                    if (vlSelfRef.sim_top__DOT__tb__DOT__we) {
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4__DOT__flip_flop_d__DOT__d 
                            = (1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__din) 
                                     >> 3U));
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r3__DOT__flip_flop_d__DOT__d 
                            = (1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__din) 
                                     >> 2U));
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r2__DOT__flip_flop_d__DOT__d 
                            = (1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__din) 
                                     >> 1U));
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__d 
                            = (1U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__din));
                    } else {
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4__DOT__flip_flop_d__DOT__d 
                            = (1U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r4__q));
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r3__DOT__flip_flop_d__DOT__d 
                            = (1U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r3__q));
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r2__DOT__flip_flop_d__DOT__d 
                            = (1U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r2__q));
                        vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__d 
                            = (1U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r1__q));
                    }
                }
            }
        }
...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r1__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r2__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r3__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r4__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r4__DOT__flip_flop_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3305745874899938358ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r3__DOT__flip_flop_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12351890586113380511ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r2__DOT__flip_flop_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1846099852555301752ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__rst = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6904929620829535758ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15085138140952217572ull);
