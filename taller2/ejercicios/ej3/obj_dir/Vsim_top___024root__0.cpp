...
VlCoroutine Vsim_top___024root___eval_initial__TOP__Vtiming__1(Vsim_top___024root* vlSelf) {
    ...
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__1__got 
        = ((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r4__q) 
             << 3U) | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r3__q) 
                       << 2U)) | (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r2__q) 
            ...
            if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    ...
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r4__q 
                        = ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__rst)) 
                           & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4__DOT__flip_flop_d__DOT__d));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r3__q 
                        = ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__rst)) 
                           & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r3__DOT__flip_flop_d__DOT__d));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r2__q 
                        = ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__rst)) 
                           & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r2__DOT__flip_flop_d__DOT__d));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__r1__q 
                        = ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__rst)) 
                           & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__flip_flop_d__DOT__d));
                }
