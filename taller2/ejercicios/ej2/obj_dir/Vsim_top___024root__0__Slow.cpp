            ...
            if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
                {
                    ...
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__flip_flop_d__DOT__d 
...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__flip_flop_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3632413088345710100ull);
