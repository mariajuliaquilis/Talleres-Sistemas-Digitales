...
void Vsim_top___024root__trace_chg_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgCData(oldp+4,(((IData)(vlSelfRef.sim_top__DOT__tb__DOT__a) 
                                & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__b))),4);
        bufp->chgIData(oldp+5,(vlSelfRef.sim_top__DOT__tb__DOT__i),32);
        bufp->chgIData(oldp+6,(vlSelfRef.sim_top__DOT__tb__DOT__j),32);
