...
class alignas(VL_CACHE_LINE_BYTES) Vsim_top___024root final {
  public:
    ...
    CData/*0:0*/ sim_top__DOT__tb__DOT__cin;
    CData/*4:0*/ sim_top__DOT__tb__DOT__expected;
    CData/*3:0*/ sim_top__DOT__tb__DOT__dut__DOT__sum;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__fa2__DOT__s1__DOT__b;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__fa1__DOT__s1__DOT__b;
