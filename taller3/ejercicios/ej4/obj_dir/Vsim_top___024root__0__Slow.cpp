...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__bin = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4782885873097270369ull);
    vlSelf->sim_top__DOT__tb__DOT__expected = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 10660180732151087192ull);
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__diff = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 6990661958718313140ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__fs3__DOT__bout = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4600416136721512258ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__fs3__DOT__r1__DOT__b = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5892403977588621180ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__fs2__DOT__r1__DOT__b = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 661774378899624033ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__fs1__DOT__r1__DOT__b = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12071818936155807338ull);
