...
class alignas(VL_CACHE_LINE_BYTES) Vsim_top___024root final {
  public:
    ...
    CData/*0:0*/ sim_top__DOT__tb__DOT__bin;
    CData/*4:0*/ sim_top__DOT__tb__DOT__expected;
    CData/*3:0*/ sim_top__DOT__tb__DOT__dut__DOT__diff;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__fs3__DOT__bout;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__fs3__DOT__r1__DOT__b;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__fs2__DOT__r1__DOT__b;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__fs1__DOT__r1__DOT__b;
