...
VlCoroutine Vsim_top___024root___eval_initial__TOP__Vtiming__1(Vsim_top___024root* vlSelf) {
    ...
    while (VL_GTS_III(32, 0x00000200U, vlSelfRef.sim_top__DOT__tb__DOT__i)) {
        vlSelfRef.sim_top__DOT__tb__DOT__bin = (1U 
        ...
        if (((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__fs3__DOT__bout) 
               << 4U) | (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__diff)) 
