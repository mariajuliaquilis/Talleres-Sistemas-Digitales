...
void Vsim_top___024root__trace_chg_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgBit(oldp+0,((1U & (0x2418U >> ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                << 2U)))));
        bufp->chgBit(oldp+1,((1U & (0x2418U >> ((IData)(1U) 
                                                + ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                   << 2U))))));
        bufp->chgBit(oldp+2,((1U & (0x2418U >> ((IData)(2U) 
                                                + ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                   << 2U))))));
        bufp->chgBit(oldp+3,((1U & (0x2418U >> ((IData)(3U) 
                                                + ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                   << 2U))))));
        bufp->chgCData(oldp+4,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__posicion_porton__DOT__posicion_actual),2);
        bufp->chgCData(oldp+5,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual),2);
        bufp->chgCData(oldp+6,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__posicion_porton__DOT__posicion_actual),2);
        bufp->chgCData(oldp+7,(Vsim_top__ConstPool__TABLE_hfe368203_0
                               [((8U & ((0x2418U >> 
                                         ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                          << 2U)) << 3U)) 
                                 | ((4U & ((0x2418U 
    ...
    bufp->chgBit(oldp+8,(vlSelfRef.sim_top__DOT__clk));
    bufp->chgBit(oldp+9,(vlSelfRef.sim_top__DOT__rst));
    bufp->chgBit(oldp+10,(vlSelfRef.sim_top__DOT__done));
    bufp->chgBit(oldp+11,(vlSelfRef.sim_top__DOT__pass_all));
    bufp->chgBit(oldp+12,(vlSelfRef.sim_top__DOT__tb__DOT__button));
    bufp->chgIData(oldp+13,(vlSelfRef.sim_top__DOT__tb__DOT__nfail),32);
    bufp->chgBit(oldp+14,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__button_q));
    bufp->chgCData(oldp+15,(Vsim_top__ConstPool__TABLE_h7a1c620d_0
