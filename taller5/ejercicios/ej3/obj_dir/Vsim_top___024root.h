...
class alignas(VL_CACHE_LINE_BYTES) Vsim_top___024root final {
  public:
    ...
    CData/*1:0*/ sim_top__DOT__tb__DOT__dut__DOT__posicion_porton__DOT__posicion_actual;
    CData/*2:0*/ sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual;
