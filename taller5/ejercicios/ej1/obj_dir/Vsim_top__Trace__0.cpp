...
void Vsim_top___024root__trace_chg_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgBit(oldp+0,((1U & (0x8421U >> ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                << 2U)))));
        bufp->chgBit(oldp+1,((1U & (0x8421U >> ((IData)(1U) 
                                                + ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                   << 2U))))));
        bufp->chgBit(oldp+2,((1U & (0x8421U >> ((IData)(2U) 
                                                + ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                   << 2U))))));
        bufp->chgBit(oldp+3,((1U & (0x8421U >> ((IData)(3U) 
                                                + ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual) 
                                                   << 2U))))));
        bufp->chgCData(oldp+4,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__estado_actual),2);
    }
