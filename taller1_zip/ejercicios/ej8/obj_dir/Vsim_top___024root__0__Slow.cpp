            ...
            if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
                {
                        ...
                        = (0x0000001fU & ((0x00000100U 
                                           ...
                                           : ((0x0000000fU 
                                              ...
                                              + (0x0000000fU 
                                                 & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__value) 
                                                    >> 4U)))));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__rc1__DOT__b1 
                    ...
                    vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1 
                        = (0x0000000fU & (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__value) 
                                           >> 4U) ^ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value)));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s4b__DOT__c2 
                        = (1U & (((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                                  >> 1U) | ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                                            & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                               >> 1U))));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__b2 
                        = (1U & (((~ ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                      >> 1U)) & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__rc1__DOT__b1)) 
                                 | (IData)((2U == (0x0022U 
                                                   & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))))));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s4b__DOT__c3 
                        = (1U & (((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                                  >> 2U) | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s4b__DOT__c2) 
                                            & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                               >> 2U))));
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__b3 
                        = (1U & (((~ ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                      >> 2U)) & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__b2)) 
                                 | (IData)((4U == (0x0044U 
                                                   & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))))));
                }
            }
...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__b2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13132753604328337141ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__b3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12317367774510271160ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__r4b__DOT__rc1__DOT__b1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2684373240259639171ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__s4b__DOT__c2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11779286002069694018ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__s4b__DOT__c3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6770510456925379149ull);
