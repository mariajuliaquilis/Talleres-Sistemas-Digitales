...
class alignas(VL_CACHE_LINE_BYTES) Vsim_top___024root final {
  public:
    ...
    CData/*4:0*/ sim_top__DOT__tb__DOT__tmp;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__b1;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__b2;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__b3;
